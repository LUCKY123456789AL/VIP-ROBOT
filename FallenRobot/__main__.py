...
BOT_TOKEN = 
MONGO_URL = "mongodb+srv://Mongo_Db_Bot:@cluster0.hct06fi.mongodb.net/?retryWrites=true&w=majority"
...
async def start(client, message):
        await message.reply_text("𝙷𝚎𝚕𝚕𝚘 𝙸 𝚊𝚖 𝙰𝙸 𝙲𝙷𝙰𝚃 𝙱𝙾𝚃 𝙲𝚛𝚎𝚍𝚒𝚝 𝚋𝚢 @DAXXSIR3
𝚄 𝙽𝙴𝙴𝙳 𝙶𝙸𝚁𝙻𝙵𝚁𝙸𝙴𝙽𝙳 𝙿𝙻𝚉 𝙹𝙾𝙸𝙽 @cyberdaxx")
